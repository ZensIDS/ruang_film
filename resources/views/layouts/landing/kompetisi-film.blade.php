                    ...
                    <div
                        ...
                        <div class="p-6 flex flex-col flex-grow">
                            ...
                            <p style="text-align: justify;" class="text-gray-300 text-sm leading-relaxed mb-6">
                                {!! nl2br(e($category->resolved_summary)) !!} <br>
                            </p>
                            ...
                            @php
                                ...
                                // tentukan daftar file juknis (bisa lebih dari 1)
                                $juknisFiles = match (true) {
        ...
        @if ($showCompetitionSubmittedStat)
            <div class="mt-12 pt-10 border-t border-purple-500/20">
                <div class="text-center space-y-4">
                    <div
                        class="text-5xl md:text-7xl font-black bg-gradient-to-r from-purple-400 via-fuchsia-400 to-purple-300 bg-clip-text text-transparent">
                        <span class="counter counter-value"
                            data-target="{{ $competitionFilmSubmittedStatValue ?? 0 }}">{{ $competitionFilmSubmittedStatValue ?? 0 }}</span>+
                    </div>
