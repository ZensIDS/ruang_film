...
<section
    ...
    class="js-accordion-item relative min-h-[90vh] flex items-center justify-center px-6 py-20 overflow-hidden bg-cover bg-center"
    ...
    <div class="relative max-w-7xl w-full mx-auto">
        <div class="relative max-w-6xl w-full mx-auto fade-up">
            ...
            <div class="mt-10 flex justify-center">
                <button
                    type="button"
                    class="js-accordion-toggle group w-14 h-14 rounded-full glass-card-light flex items-center justify-center border border-purple-500/30 cursor-pointer"
                    aria-expanded="false"
                    aria-controls="program-list-{{ $programCategory->slug }}"
                    aria-label="Lihat program {{ strtolower($programCategory->name) }}">
                    <div class="js-accordion-icon">
                        <i class="fas fa-chevron-down text-purple-400 text-xl transition-all duration-300 group-hover:text-purple-300"></i>
                    </div>
                </button>
            </div>
        </div>

        <div id="program-list-{{ $programCategory->slug }}" class="js-accordion-panel max-h-0 opacity-0 overflow-hidden transition-all duration-500 ease-in-out">
            <div class="mt-10 glass-card rounded-3xl p-6 md:p-8 lg:p-10 fade-up">
