        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id="taskForm" action="{{ route('film.update', $film->id) }}" method="POST"
                        ...
                        <div class="box-body">
                            ...
                            @else
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $film->category->name ?? '-' }}"
                                        readonly>
                                </div>
                            @endif
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="Masukkan judul film"
                                            ...
                                            <div class="radio" style="display:inline-block; margin-right:20px;">
                                                <label style="font-weight:normal; cursor:pointer;">
                                                    <input type="radio" name="subtitle" value="Ya"
                                                        {{ old('subtitle', $film->subtitle) == 'Ya' ? 'checked' : '' }}
                                                        required> Ya
                                                </label>
                                            </div>
                                            <div class="radio" style="display:inline-block;">
                                                <label style="font-weight:normal; cursor:pointer;">
                                                    <input type="radio" name="subtitle" value="Tidak"
                                                        {{ old('subtitle', $film->subtitle) == 'Tidak' ? 'checked' : '' }}
                                                        required> Tidak
                                                </label>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div style="display:flex; align-items:center; gap:6px;">
                                            <input type="number" id="dur_h" min="0" max="0"
                                            ...
                                            <input type="number" id="dur_m" min="0" max="30"
                                                class="form-control" style="width:70px; text-align:center; font-weight:600;"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="sinopsis" class="form-control" rows="4" placeholder="Tuliskan sinopsis film..." required>{{ old('sinopsis', $film->sinopsis) }}</textarea>
                            </div>

                            {{-- Kru Film --}}
                            <h5
                                style="font-weight:700; border-left:3px solid #1db9a0; padding-left:10px; margin:20px 0 16px;">
                                Kru Film</h5>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="sutradara" class="form-control"
                                            placeholder="Nama sutradara" value="{{ old('sutradara', $film->sutradara) }}"
                                            required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="produser" class="form-control"
                                            placeholder="Nama produser" value="{{ old('produser', $film->produser) }}"
                                            required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if ($film->kru)
                                            <div style="margin-bottom:8px;">
                                                ...
                                                <span style="font-size:11px; color:#888; margin-left:6px;">Upload baru
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if ($film->poster)
                                            <div style="margin-bottom:8px;">
                                                ...
                                                <div style="font-size:11px; color:red; margin-top:4px;">Poster saat ini.
                                                    Upload baru untuk mengganti.</div>
                                            </div>
                                        @endif
                                        <input type="file" name="poster" class="form-control" accept="image/*">
                                        <p class="text-danger">Format: JPG, PNG. Maks 5MB. Kosongkan jika tidak ingin
                                            mengganti.</p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                        ...
                                        @if (count($gsmFiles) > 0)
                                            <div
                                                ...
                                                @foreach ($gsmFiles as $i => $path)
                                                    <div
                                                        style="aspect-ratio:1/1; border-radius:6px; overflow:hidden; border:0.5px solid #ddd; position:relative;">
                                                        <img src="{{ $gsmUrls[$i] ?? $film->mediaUrl($path) }}"
                                                            style="width:100%; height:100%; object-fit:cover;">
                                                        <div
                                                            style="position:absolute;bottom:0;left:0;right:0;background:rgba(0,0,0,0.45);color:#fff;font-size:9px;text-align:center;padding:2px 0;">
                                                            {{ $i + 1 }}
                                                        </div>
                                                    </div>
                                                @endforeach
                                            </div>
                                            <div style="font-size:11px; color:red; margin-bottom:6px;">Grab Still Photo
                                                saat ini ({{ count($gsmFiles) }} file). Upload baru untuk mengganti semua.
                                            </div>
                                        @endif
                                        <input type="file" name="gsm[]" class="form-control" id="gsm_input"
                                            multiple>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Screenshot Bukti Unggah / Repost</label>
                                        @php
                                            $other2IsImage = \Illuminate\Support\Str::endsWith(
                                                strtolower((string) $film->other_2),
                                        ...
                                        @if ($film->other_2)
                                            <div style="margin-bottom:8px;">
                                                @if ($other2IsImage)
                                                    <a href="{{ $film->other_2_url }}" target="_blank"
                                                        style="display:inline-block;">
                                                        <img src="{{ $film->other_2_url }}"
                                                            style="height:100px; border-radius:6px; border:0.5px solid #ddd; object-fit:cover;">
                                                    </a>
                                                    <div style="font-size:11px; color:red; margin-top:4px;">File saat ini.
                                                        Upload baru untuk mengganti.</div>
                                                @else
                                                    <a href="{{ $film->other_2_url }}" target="_blank"
                                                        style="font-size:12px; color:#0d6efd; display:inline-flex; align-items:center; gap:5px;">
                                        ...
                                        @endif
                                        <input type="file" name="other_2" class="form-control" accept="image/*,.pdf">
                                        <p class="text-danger">Upload bukti unggah/repost. Kosongkan jika tidak ingin
                                            mengganti.</p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <p class="text-danger">Masukkan link Google Drive. Pastikan Akses Link Sudah
                                            Dibuka.</p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="url" name="film" class="form-control"
                                            placeholder="Masukkan Link Film" value="{{ old('film', $film->film) }}"
                                            required>
                                        <p class="text-danger">Masukkan link Google Drive. Pastikan Akses Link Sudah
                                            Dibuka.</p>
                                    </div>
                            ...
                            <div id="dynamic_field"
                                ...
                                <label id="dynamic_label" style="font-weight:600; color:#0a7a5e;">
                                    @if ($film->category_id == 1)
                                        Press Kit (Opsional)
                                    @elseif(in_array($film->category_id, [2, 4]))
                                ...
                                @if ($film->other_1)
                                    <div style="margin:6px 0 8px;">
                                        ...
                                        <span style="font-size:11px; color:#888; margin-left:6px;">Upload baru untuk
                                            mengganti.</span>
                                    </div>
                                @endif
                                <input type="file" name="other_1" id="dynamic_input" class="form-control"
